      ...
      <main className="flex text-center">
          ...
          <div className="self-center p-4 grid mx-auto mt-32 sm:mt-20 sm:ml-8">
            ...
            >
              ...
              <div className="flex justify-center">
                <button
                  id="botão"
                  className="bg-blue-500 text-lg text-white font-sans w-48 h-9 self-center mx-auto rounded-xl font-bold hover:scale-105 hover:bg-blue-[#488cf9] ease-in-out duration-300"
                >
                  Entrar
                </button>
              </div>
        ...
        {!imagemCarregada && (
          <Skeleton
            ...
            className="mx-auto aspect-[1.80] sm:block hidden mt-10 relative w-20"
          />
        )}
        <img
          alt=""
          ...
          className="w-5/12 sm:block hidden mx-auto mt-16 transition-opacity duration-300"
          onLoad={() => {
